...
import (
	...
	versioned "github.com/ricardomaraschini/tagger/infra/tags/v1/gen/clientset/versioned"
	internalinterfaces "github.com/ricardomaraschini/tagger/infra/tags/v1/gen/informers/externalversions/internalinterfaces"
	v1 "github.com/ricardomaraschini/tagger/infra/tags/v1/gen/listers/tags/v1"
...
func (f *tagInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tagsv1.Tag{}, f.defaultInformer)
}
